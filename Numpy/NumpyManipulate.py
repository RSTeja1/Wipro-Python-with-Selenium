...
arr = np.zeros((2,3,4)) #2 is blocks, 3 is rows, 4 is columns
print(arr)
...
#swapaxes() - Interchanging two axes of an array
arr = np.zeros((2,3,4))
print(arr)
...
#moveaxis() - moves specified axis to new position
arr = np.zeros((2,3,4))
print(arr)
new_arr = np.moveaxis(arr, 0, -1) #(3,4,2)
print(new_arr)
